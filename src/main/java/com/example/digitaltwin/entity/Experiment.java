...
public class Experiment {
    ...
    /** 仿真模式：SINGLE / MULTI_ORGAN */
    private String simulationMode;
    /** 观测指标名称（单指标模式必填） */
    private String indicatorName;
    /** 目标器官（多器官模式必填，逗号分隔：Heart,Liver,Lung） */
    private String targetOrgans;
    /** 方案说明 */
    ...
    public String getTargetOrgans() {
        return targetOrgans;
    }

    public void setTargetOrgans(String targetOrgans) {
